...
### Tag: package-2016-04-preview and go

These settings apply only when `--tag=package-2016-04-preview --go` is specified on the command line.
Please also specify `--go-sdk-folder=<path to the root directory of your azure-sdk-for-go clone>`.

``` yaml $(tag)=='package-2016-04-preview' && $(go)
namespace: compute
...
### Tag: package-2016-04-preview and python

These settings apply only when `--tag=package-2016-04-preview --python` is specified on the command line.

``` yaml $(tag) == 'package-2016-04-preview' && $(python)
namespace: azure.mgmt.compute.compute.v2016_04_30_preview
```

### Tag: package-2016-03 and python

These settings apply only when `--tag=package-2016-03 --python` is specified on the command line.

``` yaml $(tag) == 'package-2016-03' && $(python)
